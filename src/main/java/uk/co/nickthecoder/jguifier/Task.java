...
public abstract class Task
{
    ...
    public void guifierHelp()
    {
    	...
    	System.out.println( "    --prompt, --no-prompt   : Overrides whether the parameters should be prompted using a GUI" );
    	System.out.println( "    --debug, --no-debug     : May be useful to turn on debugging while developing your script" );
    	System.out.println();
    }
    ...
    private void autocomplete( String[] argv )
    {
    	...
    	String cur = params[ index ];
		String prev = (index > 0) ? params[ index - 1 ] : "";
		
		/*
    	System.err.println( "Autocomplete arguments" );
    	for ( String arg : argv ) {
